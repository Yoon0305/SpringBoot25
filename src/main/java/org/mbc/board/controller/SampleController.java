...
public class SampleController {
    ...
    @GetMapping("/ex/ex1") // http://192.168.111.105/ex/ex1 -> void type -> /resources/templates/ex/ex1.html
    ...
    @ToString
    class SampleDTO{
        //inner class로, 클래스 안쪽에 class를 선언할 때 활용 된다.
    ...
    public void ex2(Model model){
        log.info("SampleController.ex2 method execute");
        //inner class 이용해서 객체를 뿌려보자.

        List<String> strList = IntStream.range(1,10) // 1~10까지 정수를 생성
                .mapToObj(i -> "데이터"+i)
